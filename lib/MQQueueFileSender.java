...
public class MQQueueFileSender {
    public static void main(String[] args) {
        // Verificar que se proporcionaron todos los argumentos necesarios
        if (args.length < 7) {
            System.out.println("Uso: java MQQueueSender <qMgr> <connName> <channel> <qName> <userId> <password> <fileName>");
            System.exit(1);
        }
        ...
        try {
            ...
            String msg = new String(Files.readAllBytes(Paths.get(fileName)));
            ...
            System.out.println("Mensaje enviado exitosamente desde el archivo: " + fileName);
